...
@Component({
  selector: 'app-chef-de-service-fop',
  templateUrl: './chef-de-service-fop.component.html',
  styleUrls: ['./chef-de-service-fop.component.css']
})
export class ChefDeServiceFopComponent implements OnInit {
