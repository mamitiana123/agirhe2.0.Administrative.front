...
@Component({
  selector: 'app-chef-de-division-fop',
  templateUrl: './chef-de-division-fop.component.html',
  styleUrls: ['./chef-de-division-fop.component.css']
})
export class ChefDeDivisionFopComponent implements OnInit {
