...
@Component({
  selector: 'app-chef-de-division-mef',
  templateUrl: './chef-de-division-mef.component.html',
  styleUrls: ['./chef-de-division-mef.component.css']
})
export class ChefDeDivisionMefComponent implements OnInit {
