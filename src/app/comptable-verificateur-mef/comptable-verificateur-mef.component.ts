...
@Component({
  selector: 'app-comptable-verificateur-mef',
  templateUrl: './comptable-verificateur-mef.component.html',
  styleUrls: ['./comptable-verificateur-mef.component.css']
})
export class ComptableVerificateurMefComponent implements OnInit {
