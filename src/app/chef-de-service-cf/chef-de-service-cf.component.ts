...
@Component({
  selector: 'app-chef-de-service-cf',
  templateUrl: './chef-de-service-cf.component.html',
  styleUrls: ['./chef-de-service-cf.component.css']
})
export class ChefDeServiceCFComponent implements OnInit {
