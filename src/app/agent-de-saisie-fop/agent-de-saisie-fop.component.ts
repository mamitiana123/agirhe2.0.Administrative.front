...
@Component({
  selector: 'app-agent-de-saisie-fop',
  templateUrl: './agent-de-saisie-fop.component.html',
  styleUrls: ['./agent-de-saisie-fop.component.css']
})
export class AgentDeSaisieFopComponent implements OnInit {
